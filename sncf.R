...
json_arrivees <- fromJSON("https://edc8d4f0-0154-4441-8928-848a15fd2e42@api.sncf.com/v1/coverage/sncf/stop_areas/stop_area:SNCF:87212027/arrivals?count=1000&")
View(json_arrivees)
